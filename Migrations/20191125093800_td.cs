    ...
    public partial class td : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShoppingCartItemId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HeadphonesId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCartItems_Headphones_HeadphonesId",
            ...
            migrationBuilder.InsertData(
                table: "Headphones",
                columns: new[] { "HeadphonesId", "CategoryId", "Description", "ImageHumbnailUrl", "ImageUrl", "InStock", "Name", "PopularHeadphones", "Price" },
                values: new object[] { 1, 3, "Over head phones", "https://i.imgur.com/axatiZR.jpg", "https://assets.sennheiser.com/img/18209/product_detail_x2_desktop_HD_559_Sennheiser_01.jpg", true, "Sennheiser HD559", true, 123.4m });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItems_HeadphonesId",
