...
namespace HeadphonesStore.Controllers
{
    public class ShoppingCartController : Controller
    {
        ...
        {
            var selectedHeadphones = _headphonesRepo.Headphones.FirstOrDefault(p => p.HeadphonesId == headphonesId);
        ...
        {
            var selectedHeadphones = _headphonesRepo.PopularHeadphones.FirstOrDefault(p => p.HeadphonesId == headphonesId);
